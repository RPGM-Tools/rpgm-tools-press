...
version: "v1.0.0"
publishedAt: "2026-08-26T14:37:02Z"
url: "https://github.com/neostryder/neo-angband/releases/tag/v1.0.0"
kind: "core"
emoji: "🗡️"
summary: "Browser/PWA icons now use the real mascot artwork, policy/legal docs ship beside the desktop executable, and over a thousand previously hardcoded web-frontend strings are now translatable. Players also get smoother gameplay: tile pack selection no longer appears to hang, the birth stat screen finally shows a cursor, h/j/k/l navigation works throughout, the store's context menu renders properly, long messages wrap cleanly across pages, and an autoplayer can be interrupted with a real keypress instead of needing a force-quit."
