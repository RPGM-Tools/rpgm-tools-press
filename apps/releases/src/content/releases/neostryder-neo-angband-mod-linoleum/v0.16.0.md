...
emoji: "🎨"
color: "#27ae60"
summary: "Shapechanged characters, such as a Druid in bear or werewolf form, are now drawn as the matching creature with colors derived from the character's class and race, though this is off by default and requires game version 0.27.0 or later to function. Some tile packs are missing artwork for a few creature tiers (notably werewolves and Beorn under Original Tiles, Adam Bolt, Nomad, and Gervais), so those forms fall back to a lower-tier creature rather than disappearing."
---
