...
emoji: "🤖"
color: "#1f8ecd"
summary: "This release adds a new toggle that makes the Borg deliberately undervalue common early-game stockpiles (potions of resist poison and speed, phase door, recall, and cure potions) for a fast \"munchkin\" run before a set level. Players on Neo Angband 0.27.0 or newer also pick up"
---
