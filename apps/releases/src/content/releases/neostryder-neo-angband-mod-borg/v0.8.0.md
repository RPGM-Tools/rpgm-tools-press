...
kind: "mod"
emoji: "🤖"
summary: "The Borg now exposes eight upstream behavior settings as mod manager toggles with stock defaults preserved, and two long-standing bugs are fixed so it actually reads its configuration and saves up for items it wants by default."
---
