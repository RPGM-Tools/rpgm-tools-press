...
kind: "mod"
emoji: "🤖"
summary: "This release now requires Neo Angband 0.25.0 or newer and will refuse to load on older versions. The README has also been corrected to clarify that using the Borg permanently marks the save as non-scoring and that the engine automatically restarts the character on death rather than the mod itself."
---
