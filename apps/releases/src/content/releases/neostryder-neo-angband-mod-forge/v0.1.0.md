...
version: "v0.1.0"
publishedAt: "2026-08-23T07:25:35Z"
url: "https://github.com/neostryder/neo-angband-mod-forge/releases/tag/v0.1.0"
kind: "mod"
emoji: "🧰"
summary: "The first release of Neo Angband's ModForge adds an in-game workshop, opened from a screen corner, that lets players create, edit, validate, and test mods with evidence-based suggestions and a live test panel, or fall back to direct file editing.\n\nNotable limitations include the suggested values being drawn from a small fixture rather than the game's own records, mods containing scripts being excluded from one-click session testing, and no way to install a finished mod directly into the library from the workshop."
---
