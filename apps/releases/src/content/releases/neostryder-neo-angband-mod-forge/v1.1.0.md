...
version: "v1.1.0"
publishedAt: "2026-08-27T04:08:55Z"
url: "https://github.com/neostryder/neo-angband-mod-forge/releases/tag/v1.1.0"
kind: "mod"
emoji: "🧰"
summary: "Neo Angband: ModForge v1.1.0 embeds the full SDK documentation directly inside the workshop so tutorials and API references are now reachable from the title screen, Guide cards, About screen, and the \"Start a plugin.js\" flow. It also polishes the workshop's layout (single type scale and gutter, higher contrast, consistent card styling) and fixes a wide range of usability issues, including cards and files that could not be opened, disabled fields that looked live, missing focus states, and a banner that swallowed empty space."
---
