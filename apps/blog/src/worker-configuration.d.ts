/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: ac445715124972505e3b0f79562f58b6)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	SEARCH_EMBEDDING_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
}
